...
The below image is for mapping image labels with images. I showed these indexes to compare real traffic sign images with my model's predicted indexes.

![alt text][image2]

The image below is to check distribution of images based on the indexes. Based on this, I will suggest further improvement of the model later. 
...
I created grayed and normalized images in preprocessing phase as the below
...
| Flatten	            |       										|
| Droout        		| 0.5       									|
| Fully connected		| 400x1024        								|
| Fully connected		| 1024x512        								|
| Droout        		| 0.5       									|
| Fully connected		| 512x256        								|
...
* How does the final model's accuracy on the training, validation and test set provide evidence that the model is working well?
    - The accuracy is the above, and I think it works pretty well.
...
The accuracy was pretty good, but because there is not enough data in case of Pedestrians, it is a little low, and we can augment the number of the image. Further, we can increase the number of the traffic images in smaller number based on the traffic images indexes in the bar graph above compared to other traffic images.
